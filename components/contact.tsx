...
export default function Contact() {
 const {ref} = useSectionInView("Contact");
  ...
  return <motion.section ref={ref} id="contact" className="mb-20 sm:mb-28 w-[min(100%,38rem)] text-center"
  initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:1}} viewport={{once:true}}>
        ...
        href="mailto:adnan.anjar2002@gmail.com">adnan.anjar2002@gmail.com</a>{" "}or
            through this form.
        </p>
        ...
        <form className="mt-10 flex flex-col dark:text-black" action={async (formData) => {
            ...
            <input name="senderEmail" className="h-14 px-4 rounded-lg borderBlack dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none" type="email" placeholder="Your email" required maxLength={500} />
